...
internal fun runExpectTest(testBody: suspend ExpectTestScope.() -> Unit) {
    runTest {
...
internal class ExpectTest(override val coroutineContext: CoroutineContext) : ExpectTestScope {
